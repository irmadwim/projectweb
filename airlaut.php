				...
				<div class="col">
					<div class="home_container">
						<div class="home_content">
							<div class="home_title">Ikan Air Laut</div>
							<div class="breadcrumbs">
								<ul>
									<li><a href="index.php">Home</a></li>
									<li><a href="airlaut.php">Ikan Air Laut</a></li>
								</ul>
							</div>
						</div>
					</div>
		...
		<div class="container">
			<div class="row">
				<div class="col-12">
					...
					<div class="current_page">Ikan Air Laut</div>
				</div>
				<div class="col-12">
			...
			<div class="row products_container">
				...
				<div class="col">
					...
					<div class="product_grid">
						...
						<!-- Product -->
						<?php
							$query=mysqli_query($CON,"SELECT * FROM product WHERE jenis_product='ikanairlaut'");
