		...
		<div class="container">
			<div class="row">
				<div class="col-12">
						...
						<div class="sidebar_section">
							...
							<div class="sidebar_section_content">
								<ul>
									...
									<li><a href="airtawar.php">Ikan Air Tawar (5)</a></li>
							...
							<div class="sidebar_section_content bestsellers_content">
								<ul>
									...
									<li class="clearfix">
										...
										<div class="best_image"><img src="images/<?php echo $pecah['gambar']?>" width="500px" class="img-thumbnail"></div>
					...
					<div class="current_page">All Categories</div>
				</div>
				<div class="col-12">
						...
						<div class="product">
							...
							<div class="product_content clearfix">
								...
								<div class="product_options">
									<a href="add_to_cart.php?id=<?php echo $data['id_product'] ?>"><div class="product_buy product_option"><img src="images/shopping-bag-white.svg" alt=""></div></a>
