	...
	<div class="checkout">
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-6">
					<div class="billing">
						<div class="checkout_title">Order Form</div>
					...
					<div class="cart_details">
						...
						<div class="payment_options">
							<div>
								...
								<label for="radio_payment_1">debit card</label>
								<div class="visa payment_option"><a href="#"><img src="images/bca.png" alt=""></a></div>
							</div>
							<div>
